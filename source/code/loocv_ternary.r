...
# provide user input
baseDir             <- "c:/dino_nature/output/test_loocv"                          # base directory where loocv sets will be located
...
addTreeTips         <- TRUE                                                                       # FALSE for LOOCV normally (unless still including test taxa in which new variants have been added)
