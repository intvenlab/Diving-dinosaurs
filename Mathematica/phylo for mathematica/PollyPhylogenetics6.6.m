...
PhylogeneticsVersion[]:=Print["Phylogenetics for Mathematica 6.6\n(c) P. David Polly, 26 November 2022\n"];
...
DrawNewickTree[tree_]:=Block[{TreeTable,myTable,ExtNodeNames,ImmediateDescendants,FindLineage,TipEntries,NodeEntries,NodeNames,TipNames,TipY,TipLineages,NodeLineages,Descendants,NodeY,TreeX,TreeY,TreeXY,x},
...
InvLambdaCmat=Inverse[LambdaCmat];
